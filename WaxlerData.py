...
#Identify the XML file to work from:
OSM_PATH = "BeaverCounty.osm"
#Idenfity the CSV files to be created at the end:
...
#This mapping will aide us in correcting street names later in our shape elements function
mapping = {
            " St ": " Street ",
            " St.": " Street ",
            " Rd.": " Road ",
...
'''
Below the intent is this:  for each element, send through cleaning function- check for item -is it what is being cleaned, and
if so, send value through function
'''    
    if element.tag == 'node':
        ...
        for child in element:
            ...
            if (child.tag == 'tag'):
                ...
                if (colon != -1):
                    ...
                    if key_value=="postcode": 
                        update_postcode(v_value)
                    #    print(v_value)
                    #    return #(v_value)
                    if key_value=="street":
                        update_street_name(v_value, mapping)
                    #    print(v_value)
                    #    return #(v_value)
                else:
        ...
        for tag in element.iter('tag'):
            ...
            # This code ignores k tags with problem characters:
            if re.search(PROBLEMCHARS,k):
                print ("One of the problem characters was found")
                continue
            else:
                pass
...
def process_map(file_in, validate):
    ...
    #Modified Udacity code to output properly to CSV and eliminate byte issue
